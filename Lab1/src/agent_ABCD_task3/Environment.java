...
//				}
	...
	public String move_left(int[][] agentlocation) {
		int newAgentLocation = new int[][];
...
//				}
			...
			if (!agentlocation.substring(0, agentlocation.indexOf("x") - 1).equals("" + envgrid.length)) {
